            ...
            <div className="w-full max-w-sm space-y-8 bg-card p-8 rounded-2xl border border-white/10 shadow-2xl">
                ...
                <div className="grid grid-cols-3 gap-3">
                    ...
                    >
                        <button
                            type="submit"
                            className="w-full flex items-center justify-center gap-2 bg-white/5 text-white font-semibold py-3 rounded-xl hover:bg-white/10 transition-colors border border-white/10"
                        >
                    ...
                    <form
                        action={async () => {
                            "use server";
                            await signIn("apple", { redirectTo: "/onboarding" });
                        }}
                    >
                        <button
                            type="submit"
