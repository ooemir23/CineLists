                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between">
                        <label className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest flex items-center gap-1.5">
                            <Star className="w-3.5 h-3.5 text-amber-400 fill-amber-400" /> Puanın
                        </label>
                        <span className="text-xs font-black text-amber-400">{rating > 0 ? `${rating} / 10` : "Puan Seç"}</span>
                    </div>
                    <div className="flex items-center justify-between bg-white/5 p-2 rounded-2xl border border-white/5 w-full overflow-x-auto no-scrollbar">
